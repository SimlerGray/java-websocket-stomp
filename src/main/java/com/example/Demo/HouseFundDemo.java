 ...
 * @version v1.2.0
 */
public class HouseFundDemo extends AbstractCredit {

    //业务参数
    public static final String method = "api.housefund.get";//请求接口
    public static final String bizType = "housefund";//业务类型
    ...
    public static void main(String[] args) throws Exception {
        ...
        //启动服务
        HouseFundDemo service  = new HouseFundDemo();
        service.process();
	...
	public void process() throws Exception{
        ...
        try {
           ...
           // doProcess(reqParam);
            ...
            System.out.println("开始获取公积金信息异常：" + ex);
        }
	}
