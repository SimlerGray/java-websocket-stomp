 ...
 * @version v1.2.0
 */
public class EducationDemo extends AbstractCredit {

    //业务参数
    public static final String method = "api.education.get";//请求接口
    public static final String bizType = "education";//业务类型
    ...
    public static void main(String[] args) throws Exception {
        ...
        //启动服务
        EducationDemo service  = new EducationDemo();
        service.process();

    }

	public void process() throws Exception{
        System.out.println("开始获取学信网信息");
        ...
        try {
         ...
         //   doProcess(reqParam);
            ...
            System.out.println("开始获取学信网信息异常：" + ex);
        }
	}
